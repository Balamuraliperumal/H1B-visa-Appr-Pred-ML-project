...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[UsVisaEstimator]:
        ...
        try:
            ...
            visa_estimator = UsVisaEstimator(bucket_name=bucket_name,
    ...
    def evaluate_model(self) -> ModelEvaluateResponse:

        try:
            test_df = pd.read_csv(self.data_ingestion_artifact.test_file_path)
            test_df['comp_age'] = CURRENT_YEAR - test_df['yr_of_estab']
            ...
            result = ModelEvaluateResponse(trained_model_f1_score=trained_model_f1_score,
