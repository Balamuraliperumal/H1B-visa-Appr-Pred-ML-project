    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        try:
            ...
            preprocessor = ColumnTransformer(
                [
                    ('Onehot-encoder', oh_transformer, oh_columns),
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                logging.info("Executed the preprocessor object")
                ...
                input_feature_train_df['comp_age'] = CURRENT_YEAR - input_feature_train_df['yr_of_estab']
                ...
                input_feature_test_df['comp_age'] = CURRENT_YEAR - input_feature_test_df['yr_of_estab']
